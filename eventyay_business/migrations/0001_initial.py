# Generated by Django 6.0.7 on 2026-09-05 17:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("overage_price__isnull", True),
                    ("overage_price__gte", 0),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("overage_block_size__isnull", True),
                    ("overage_block_size__gt", 0),
                    _connector="OR",
                ),
